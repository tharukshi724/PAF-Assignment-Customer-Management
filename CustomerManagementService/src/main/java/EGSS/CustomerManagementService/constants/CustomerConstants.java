...
public class CustomerConstants {
    ...
    public static String VIEWCUSTOMER = "select id,firstName, lastName,nic,email,street, state, postalCode,role from powergriddb.customer";
    ...
    public static String LOGUSER = "select c.id ,c.email,u.password,c.role from user u , customer c where c.id = u.uid and c.email=? and u.password=? ";
